 ...
 */
class Reservation extends \ADOB\SenofficeBundle\Entity\Reservation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Reservation' . "\0" . 'id', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Reservation' . "\0" . 'dateReservation', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Reservation' . "\0" . 'debut', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Reservation' . "\0" . 'fin', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Reservation' . "\0" . 'bien', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Reservation' . "\0" . 'client'];
        }
