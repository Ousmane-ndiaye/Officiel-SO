 ...
 */
class Video extends \ADOB\SenofficeBundle\Entity\Video implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Video' . "\0" . 'id', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Video' . "\0" . 'video', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Video' . "\0" . 'bien'];
        }
