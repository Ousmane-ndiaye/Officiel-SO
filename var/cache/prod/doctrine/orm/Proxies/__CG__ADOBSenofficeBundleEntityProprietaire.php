 ...
 */
class Proprietaire extends \ADOB\SenofficeBundle\Entity\Proprietaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Proprietaire' . "\0" . 'id', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Proprietaire' . "\0" . 'nomComplet', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Proprietaire' . "\0" . 'numPiece', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Proprietaire' . "\0" . 'adresse', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Proprietaire' . "\0" . 'email', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Proprietaire' . "\0" . 'telephone', '' . "\0" . 'ADOB\\SenofficeBundle\\Entity\\Proprietaire' . "\0" . 'password'];
        }
